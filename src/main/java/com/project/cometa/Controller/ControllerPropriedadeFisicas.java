...
public class ControllerPropriedadeFisicas {
	...
	@PutMapping("/{id}")
	public void update(@RequestBody PropriedadesFisicas prodFisicas, @PathVariable Long id) {
		 servicePropriedadesFisicas.updateDataPropriedadesFisicas(id, prodFisicas);
	}
}
