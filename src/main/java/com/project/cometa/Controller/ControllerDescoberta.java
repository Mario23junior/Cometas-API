...
public class ControllerDescoberta {
	...
	public void delete(@PathVariable Long id) {
		serviceDescoberta.deleteComet(id);
	}
	
	@PutMapping("/{id}")
	public void update(@RequestBody Descobertas descobertas, @PathVariable Long id) {
		serviceDescoberta.updateComet(descobertas, id);
	}
 }
